    ...
    <header style="height:auto; width:750px;">
        ...
        <thead>
            ...
            <tr height="20">
                ...
                <th align="left"; width="45%" style="text-decoration:underline;font-family: monospace; font-size:16px; background-color: #FFFFFF;"> <?php echo $row['address'] ?></th>
                
                <th align="left"; width="15%" style="font-family: monospace; font-size:16px; background-color: #FFFFFF;">OPD No &nbsp;: </th>
                <th align="left"; width="20%" style="text-decoration:underline; font-family: monospace; font-size:16px; background-color: #FFFFFF;">Casu-<?php echo $row['receptNumber'] ?>	</th>
                </tr>
                <tr height="20">
                
                
             <th align="left"; width="20%" style="font-size:18px;font-family: monospace; background-color: #FFFFFF;">Date/Time &nbsp;&nbsp; : </th>
                <th align="left"; width="45%" style="text-decoration:underline;font-family: monospace; font-size:16px; background-color: #FFFFFF;">  <?php $old_date = $row['date']; $old_date_timestamp = strtotime($old_date); $new_date = date('j M, Y', $old_date_timestamp); echo $new_date;  ?> /
                  <?php $old_time = $row['time'];; $old_time_timestamp = strtotime($old_time); $new_time = date('g:i A', $old_time_timestamp); echo $new_time;  ?></th>   
