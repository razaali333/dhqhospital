					...
					<div class="span12">
						<div class="widget-box">
							<div class="widget-header">
								<h4>Ward Informations</h4>
							</div>
							<div class="widget-body">
								<div class="widget-main no-padding">
									<form name="form" action="" id="ward_form" method="post">
										<fieldset>
                                                    <?php $invno=$recept->row_array(); ?> 
                                                        <div class="span2">
														<label><strong>Recept #</strong></label>
														<input type="text" class="span12" id="receptNumber" name="receptNumber" value="Ward-<?php echo $invno['receptNumber']+1 ?>" readonly/>
                                                        </div>
                                                    <div class="span4">
...
//     };
	...
	$('#save').on('click',function(e){
		...
		$.ajax({
			url:'<?php echo base_url('other/insert_ward') ?>',
			method:'POST',
			...
			{
				window.open('<?php echo base_url('other/print_ward') ?>');
				location.reload();
				$("#ward_form").reset();
			}
		})
