					...
					<div class="span12">
						<div class="widget-box">
							<div class="widget-header">
								<h4>First Male OPD Informations</h4>
							</div>
							<div class="widget-body">
								<div class="widget-main no-padding">
									<form name="form" action="" method="post">
										<fieldset>
                                                    <?php $invno=$fm_inv_no->row_array(); ?> 
                                                        <div class="span2">
														<label><strong>Recept #</strong></label>
														<input type="text" class="span12" id="receptNumber" name="receptNumber" value="FM-<?php echo $invno['receptNumber']+1; ?>" readonly/>
                                                        </div>
                                                    <div class="span4">
