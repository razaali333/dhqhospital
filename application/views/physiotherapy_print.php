...
<html lang="en">
  <head>
    ...
    <title>Physiotherapy Print</title>
    <!-- Bootstrap -->
...
<table style="width:100%; margin-bottom: 20px;">
  <tr>
    ...
    <td align="left" style="text-decoration: underline;">Phy-<?php echo $row->receptNumber; ?></td>
  </tr>
  <tr>
    <td align="left" style="font-weight: bold;">Address</td>
    <td align="left" style="text-decoration: underline;"><?php echo $row->address; ?></td>
