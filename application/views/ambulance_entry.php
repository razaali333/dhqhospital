					...
					<div class="span12">
						<div class="widget-box">
							<div class="widget-header">
								<h4>Ambulance Informations</h4>
							</div>
							<div class="widget-body">
								<div class="widget-main no-padding">
									<form name="form" action="" id="ambulance_form" method="post">
										<fieldset>
                                                    <?php $invno=$recept->row_array(); ?> 
                                                        <div class="span2">
														<label><strong>Recept #</strong></label>
														<input type="text" class="span12" id="receptNumber" name="receptNumber" value="Amb-<?php echo $invno['receptNumber']+1 ?>" readonly/>
                                                        </div>
                                                    <div class="span4">
...
//     };
	...
	$('#save').on('click',function(e){
		...
		if(name==""){
			...
			location.reload();
			$("#ambulance_form").reset();
		} else {
		$.ajax({
			url:'<?php echo base_url('other/insert_ambulance') ?>',
			method:'POST',
			...
			{
				window.open('<?php echo base_url('other/print_ambulance') ?>');
				location.reload();
				$("#ambulance_form").reset();
			}
		})
