    ...
    <header style="height:auto; width:750px;">
        ...
        <thead>
            ...
            <tr height="20">
                ...
                <th align="left"; width="20%" style="text-decoration:underline; font-family: monospace; font-size:16px; background-color: #FFFFFF;">AG-<?php echo $row['receptNumber'] ?>	</th>
                </tr>
                <tr height="20">
                
                
             <th align="left"; width="20%" style="font-size:18px;font-family: monospace; background-color: #FFFFFF;">Date/Time &nbsp;&nbsp; : </th>
                <th align="left"; width="45%" style="text-decoration:underline;font-family: monospace; font-size:16px; background-color: #FFFFFF;">
                  <?php $old_date = $row['date']; $old_date_timestamp = strtotime($old_date); $new_date = date('j M, Y', $old_date_timestamp); echo $new_date;  ?> /
