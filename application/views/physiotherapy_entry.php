					...
					<div class="span12">
						<div class="widget-box">
							<div class="widget-header">
								<h4>Physiotherapy Informations</h4>
							</div>
							<div class="widget-body">
								<div class="widget-main no-padding">
									<form name="form" action="" id="physiotherapy_form" method="post">
										<fieldset>
                                                    <?php $invno=$recept->row_array(); ?> 
                                                        <div class="span2">
														<label><strong>Recept #</strong></label>
														<input type="text" class="span12" id="receptNumber" name="receptNumber" value="Phy-<?php echo $invno['receptNumber']+1 ?>" readonly/>
                                                        </div>
                                                    <div class="span4">
                                                       ...
                                                       <div class="span6" style="margin-left: 0px;"> 
														...
														<div class="span2"> 
                                                        <label><strong>Physiotherapy</strong> &nbsp;&nbsp; </label>
...
//     };
	...
	$('#save').on('click',function(e){
		...
		if(name==""){
			...
			location.reload();
			$("#physiotherapy_form").reset();
		} else {
		$.ajax({
			url:'<?php echo base_url('other/insert_physiotherapy') ?>',
			method:'POST',
			...
			{
				window.open('<?php echo base_url('other/print_physiotherapy') ?>');
				location.reload();
				$("#physiotherapy_form").reset();
			}
		})
