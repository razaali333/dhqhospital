					...
					<div class="span12">
						<div class="widget-box">
							<div class="widget-header">
								<h4>Lab Informations</h4>
							</div>
							<div class="widget-body">
								<div class="widget-main no-padding">
									<form name="form" action="" id="lab_form" method="post">
										<fieldset>
                                                    <?php $invno=$recept->row_array(); ?> 
                                                        <div class="span2">
														<label><strong>Recept #</strong></label>
														<input type="text" class="span12" id="receptNumber" name="receptNumber" value="Lab-<?php echo $invno['receptNumber']+1 ?>" readonly/>
                                                        </div>
                                                    <div class="span4">
...
//     };
	...
	$('#save').on('click',function(e){
		...
		$.ajax({
			url:'<?php echo base_url('other/insert_lab') ?>',
			method:'POST',
			data:{receptNumber:receptNumber,name:name,address:address,age:age,shift:shift,gander:gander,sub_departement:sub_departement,type:type},
				success:function()
			{
				window.open('<?php echo base_url('other/print_lab') ?>');
				location.reload();
				$("#lab_form").reset();
			}
		})
