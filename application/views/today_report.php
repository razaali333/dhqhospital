...
<div class="page-content">
					...
					<div class="row-fluid">
                                ...
                                <div class="widget-box">
										...
										<form name="form" action="<?php echo base_url('report/today_report') ?>" method="POST">
										<fieldset>
                                            <div class="span3">
                            ...
                            <div class="row-fluid">
								...
								<table id="sample-table-2" class="table table-striped table-bordered table-hover">
									<thead>
										...
										<th width="10%" class="center">Time</th>
										<th width="15%" class="center">OPD Type</th>
									...
									<tbody id="show_record">
										...
										<tr>
											...
											$opd = "---";
											 ...
											 <td class="center"><?php $old_date = $row->time; $old_date_timestamp = strtotime($old_date); $new_date = date('h:i A', $old_date_timestamp); echo $new_date; ?></td>
									...
									<?php $total += $row->price; }  ?> 
									<tr><td colspan="10"></td>
											<td style="text-align: center;color: blue"><?php echo $total."/="; ?></td><td></td>
										</tr>
									<?php } else { ?>
